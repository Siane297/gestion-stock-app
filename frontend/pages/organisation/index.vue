<template>
    <div class="container space-y-6">
        <!-- En-tête -->
        <BannerHeader title="Gestion des Organisations" description="Gérez toutes les organisations de la plateforme" />
        ...
        <ActivationDialog
            ...
            v-model:loading="activationLoading"
...
const handleActivationSubmit = async (data: ActivateSubscriptionData) => {
