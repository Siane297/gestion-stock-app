...
const handleSubmit = async (data: Record<string, any>) => {
  ...
  try {
    ...
    if (data.conditionnements) {
        condsPayload = data.conditionnements.map((c: any) => {
            ...
            return {
                ...
                prix_achat: isBase ? (data.prix_achat !== undefined && data.prix_achat !== null && data.prix_achat !== '' ? Number(data.prix_achat) : undefined) : (c.prix_achat !== undefined && c.prix_achat !== null && c.prix_achat !== '' ? Number(c.prix_achat) : undefined),
    ...
    const payload: UpdateProduitDto = {
      ...
      marge_min_pourcent: (data.marge_min_pourcent !== undefined && data.marge_min_pourcent !== null && data.marge_min_pourcent !== '') ? Number(data.marge_min_pourcent) : undefined,
      tva_pourcentage: (data.tva_pourcentage !== undefined && data.tva_pourcentage !== null && data.tva_pourcentage !== '') ? Number(data.tva_pourcentage) : undefined,
