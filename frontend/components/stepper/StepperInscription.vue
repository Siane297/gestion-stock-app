<template>
  <div
    class="min-h-screen flex items-center justify-center bg-slot p-4">
    <div class="w-full max-w-5xl">
      <!-- Header avec effet 3D -->
      <!-- Header Simple -->
      <SimplePageHeader :title="headerTitle" :description="headerDescription" class="mb-6" />

      <!-- Carte principale du stepper -->
      <div class="bg-white rounded-lg border-2 border-gris/40  px-8 pt-5 pb-1">
        <!-- Stepper PrimeVue -->
